...
impl Buffer {
    ...
    /// Convierte un índice de carácter a un byte offset.
    pub fn char_idx_a_byte(&self, char_idx: usize) -> usize {
    ...
    // ------------------------------------------------------------------
    // Mutaciones — todas marcan el buffer como modificado automáticamente
    // ------------------------------------------------------------------
