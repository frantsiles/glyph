...
impl Cursor {
    ...
    /// Inicia o extiende una selección desde la posición actual
...
impl Selection {
    pub fn nueva(inicio_linea: usize, inicio_col: usize, fin_linea: usize, fin_col: usize) -> Self {
        Self {
...
mod tests {
    ...
    fn test_seleccion_normalizada() {
        // Selección hacia atrás — debe normalizarse
